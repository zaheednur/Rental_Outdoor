...
Route::get('/tansactions', [FrontController::class, 'transactions'])->name('front.transactions');

Route::post('/tansactions/details', [FrontController::class, 'transactions_details'])->name('front.transactions.details');
...
Route::get('/spots', [FrontController::class, 'spots'])->name('front.spots');

Route::get('/contacts', [FrontController::class, 'contacts'])->name('front.contacts');
