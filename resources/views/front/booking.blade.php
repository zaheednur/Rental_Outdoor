...
<body>
	<main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
		...
		<form action="checkout.html" class="flex flex-col gap-[30px] mt-[30px]">
			...
			<div class="flex flex-col px-5 gap-2">
				...
				<div
					...
					<input type="date" name="date" id="date" class="absolute -z-10 opacity-0" required />
				</div>
			</div>
			<div class="flex flex-col px-5 gap-2">
						...
						<div id="pickup-tab" class="tabcontent flex flex-col gap-4 hidden">
							<label
								...
								<div class="flex items-center gap-3">
									...
									<div class="flex flex-col gap-1">
										<p class="font-semibold text-sm leading-[21px]">Angga Gadgets</p>
										<p class="text-xs leading-[18px] text-[#6E6E70]">Jln Tendean Pusat Grosir No 11,
											Jakarta Pusat</p>
									</div>
								</div>
							...
							<label
								...
								<div class="flex items-center gap-3">
									...
									<div class="flex flex-col gap-1">
										<p class="font-semibold text-sm leading-[21px]">Shayna Cell</p>
										<p class="text-xs leading-[18px] text-[#6E6E70]">Jln Tendean Pusat Grosir No 11,
											Jakarta Pusat</p>
									</div>
								</div>
							...
							<label
								...
								<div class="flex items-center gap-3">
									...
									<div class="flex flex-col gap-1">
										<p class="font-semibold text-sm leading-[21px]">Glodok Sanjaya</p>
										<p class="text-xs leading-[18px] text-[#6E6E70]">Jln Tendean Pusat Grosir No 11,
											Jakarta Pusat</p>
									</div>
								</div>
							...
							<label
								...
								<div class="flex items-center gap-3">
									...
									<div class="flex flex-col gap-1">
										<p class="font-semibold text-sm leading-[21px]">Mangga Dua</p>
										<p class="text-xs leading-[18px] text-[#6E6E70]">Jln Tendean Pusat Grosir No 11,
											Jakarta Pusat</p>
									</div>
								</div>
